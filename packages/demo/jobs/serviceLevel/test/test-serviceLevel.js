/**
 * Test file for Job: serviceLevel
 */

var assert = require ('assert');
var serviceLevel_SUT = require('../serviceLevel');

var mockedConfig, mockedDependencies;

describe ('serviceLevel test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      serviceLevel_SUT.onRun(config, mockedDependencies, function(err, data){
