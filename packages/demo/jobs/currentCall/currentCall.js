...
module.exports = {
  ...
  onRun: function (config, dependencies, jobCallback) {
    ...
    /*
     ...
     It is a good idea to cover this with unit tests as well (see test/currentCall file)
     ...
     Have a look at test/currentCall for an example of how to unit tests this easily by mocking easyRequest calls

     */

    dependencies.easyRequest.HTML('http://google.com', function (err, html) {
      // logger.trace(html);
        currentCall = [{"noOfCall": "14", "duration": "01:15:34"}]
      jobCallback(err, {title: config.widgetTitle, noOfCall: '14' , duration : '01:15:35'});
    });
  }
};
