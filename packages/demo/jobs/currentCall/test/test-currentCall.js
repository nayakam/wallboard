/**
 * Test file for Job: currentCall
 */

var assert = require ('assert');
var currentCall_SUT = require('../currentCall');

var mockedConfig, mockedDependencies;

describe ('currentCall test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      currentCall_SUT.onRun(config, mockedDependencies, function(err, data){
